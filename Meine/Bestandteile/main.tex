...
To give the reader a better understanding of the context lets quickly look at the end result of this project.
\begin{figure}[H]
\centering
\includegraphics[scale=.35]{Bilder/AppOverview.png}
\captionof{figure}{The Endresult}
...
As this approach in many cases lead to more promising results than the tree layout algorithm it is the one currently in use. 
