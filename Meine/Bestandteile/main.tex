...
\section{Docker}
Docker is a platform that provides the ability to a developer to create any environment in which he wants to execute code in. While it is similar to a virtual machine, there are certain differences between them: \\(https://geekflare.com/docker-vs-virtual-machine/)
